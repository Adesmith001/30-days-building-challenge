...
export function SceneSettings({ mobile = false }: { mobile?: boolean }) {
  ...
  return (
    <details className="pointer-events-auto relative">
      ...
      <div className={`${mobile ? "mt-2 w-full" : "absolute right-0 top-10 z-20 w-56"} border border-[var(--line)] bg-[#111419] p-3 shadow-2xl`}>
